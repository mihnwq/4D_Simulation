        ...
        for (int i = 0; i < psiSegments; i++)
        {
            ...
            for (int j = 0; j < thetaSegments; j++)
            {
                ...
                for (int k = 0; k < phiSegments; k++)
                {
                    ...
                    Debug.DrawLine(transform.TransformPoint(v000),transform.TransformPoint(v100), lineColor, lineDuration); // connects points along the psi direction
                    Debug.DrawLine(transform.TransformPoint(v000),transform.TransformPoint(v010), lineColor, lineDuration); // connects points along the theta direction
                    Debug.DrawLine(transform.TransformPoint(v000),transform.TransformPoint(v001), lineColor, lineDuration); // connects points along the phi direction
